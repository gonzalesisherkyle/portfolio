            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        <span
                            class="text-accent mb-4 block text-base font-semibold"
                        >
                            Contact Me
                        </span>
                        <h2
                        ...
                        <p
                            class="text-black dark:text-white mb-9 text-base leading-relaxed"
                        >
                            Contact me if you have any questions, need extra
                            information, or setup a meeting time.
                        </p>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                                class="bg-primary text-black dark:text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                            >
                                <svg
                                    width="24"
                                    height="24"
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div
                        class="relative rounded-lg bg-white p-8 shadow-lg dark:bg-black sm:p-12"
                    >
                        <form @submit.prevent="submit">
                            <div
                                v-if="showMessage"
                                class="mb-6 p-4 bg-light bg-light-tail-100 dark:bg-dark-navy-500 text-light-secondary rounded-lg flex items-center justify-center"
                            >
                                Message sent!
                            </div>
                            <div class="mb-6">
                        ...
                        <div>
                            ...
                            <span
                                class="bg-light absolute -right-10 top-[90px] z-[-1]"
                            >
                                <svg
                                    width="34"
                                    height="134"
